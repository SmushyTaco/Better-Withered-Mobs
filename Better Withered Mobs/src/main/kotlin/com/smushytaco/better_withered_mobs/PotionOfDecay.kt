...
object PotionOfDecay {
    private fun register(name: String, potion: Potion): RegistryEntry<Potion> = Registry.registerReference(Registries.POTION, Identifier(BetterWitheredMobs.MOD_ID, name), potion)
    fun registerPotions() {
