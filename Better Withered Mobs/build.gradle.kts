...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        file.displayName = "[${libs.versions.minecraft.get()}] Better Withered Mobs"
...
modrinth {
    ...
    projectId = "better-withered-mobs"
    uploadFile.set(tasks.remapJar)
    gameVersions.add(libs.versions.minecraft)
    versionName = libs.versions.minecraft.map { "[$it] Better Withered Mobs" }
    dependencies {
