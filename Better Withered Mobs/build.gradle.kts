...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(335874, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Better Withered Mobs"
...
modrinth {
    ...
    projectId.set("better-withered-mobs")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Better Withered Mobs")
    dependencies {
